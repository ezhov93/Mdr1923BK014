...
enum Type { Undef = 0, BE9X = 1, BE1 = 2, BE4 = 3, VC1 = 4 };

const AbstractMcu mem[] = {
    {0, 0, 0, 0, 0, 0, ""},
    {0x08000000, 128 * 1024, 0x20000000, 32 * 1024, 0x20000000, 32 * 1024,
     "1986BOOTUART"},
    {0x0, 128 * 1024, 0x20000000, 32 * 1024, 0x20100000, 16 * 1024,
     "1986BOOTUART"},
    {0x0, 128 * 1024, 0x20000000, 16 * 1024, 0x20000000, 16 * 1024,
     "BOOTUARTVE4"},
    {0x08000000, 128 * 1024, 0x20000000, 32 * 1024, 0x20000000, 32 * 1024,
     "1901VC1BOOTUART"},
};
