...
class ByteArray : public QByteArray {
 public:
  ...
  // inline ByteArray &append(const  ByteArray &other) {
  // QByteArray::append(other.q()); return *this; }
  inline ByteArray &append(const qint64 i, int n) {
    QByteArray::append((const char *)&i, n);
    return *this;
  }
  inline ByteArray &append(const quint64 i, int n) {
    QByteArray::append((const char *)&i, n);
    return *this;
  }
  inline ByteArray &append(const qint64 i) {
    QByteArray::append((const char *)&i, 8);
    return *this;
  }
  ...
  inline ByteArray &append(const qint32 i) {
    QByteArray::append((const char *)&i, 4);
    return *this;
  }
  ...
  inline ByteArray &append(const qint16 i) {
    QByteArray::append((const char *)&i, 2);
    return *this;
  }
  ...
  inline ByteArray &append(const qint8 i) {
    QByteArray::append((const char *)&i, 1);
    return *this;
  }
  ...
  // inline QByteArray toHex() const { return ((QByteArray
  // *)this)->QByteArray::toHex(); } сегфолтится т.к. рекурсивно вызывает саму
  // себя не пойму какого хрена
